  ...
  const from = location.state?.from?.pathname || '/'
    ...
    return (
        ...
        <div className="hero-content grid md:grid-cols-2 gap-x-1 flex-col ">
          ...
          <h2 className="text-2xl text-red-500 text-center font-bold py-4">Login</h2>
            <form 
            ...
            <div className='py-6'>
            <p className='text-center font-bold'>New to this site? <Link to='/signup' className='text-primary'>Signup</Link></p>
        </div>
          </div>
        </div>
      </div> 
